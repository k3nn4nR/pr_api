...
class Brand extends Model
{
    ...
    /**
     * Get all of the code for the tags.
     */
    ...
    /**
     * Get all of the code for the statuses.
     */
    ...
    /**
     * Get all of the code for the codes.
     */
    public function code(): MorphMany
    {
        return $this->morphMany(Code::class, 'codeable');//->withTimestamps()->wherePivotNull('deleted_at');
    }
    ...
    /**
     * Get all of the code for the comments.
     */
